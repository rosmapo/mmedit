...
CREATE_SETTING(App, DarkMode, darkMode, bool, true)
...
CREATE_SETTING(Editor, TrimTrailingWhitespaceOnSave, trimTrailingWhitespaceOnSave, bool, false)
CREATE_SETTING(Editor, DateTimeFormat, dateTimeFormat, QString, QStringLiteral("dd.MM.yyyy HH:mm:ss"))
CREATE_SETTING(Editor, HighlightCurrentLine, highlightCurrentLine, bool, false)
CREATE_SETTING(Editor, ShowChangeHistory, showChangeHistory, bool, false)
CREATE_SETTING(Editor, SpellCheckEnabled, spellCheckEnabled, bool, false)
CREATE_SETTING(Editor, SpellCheckLanguage, spellCheckLanguage, QString, QStringLiteral("sk_SK"))
