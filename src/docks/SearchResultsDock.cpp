...
void applyResultPalette(QTextEdit *textEdit, const QPalette &treePalette)
{
    QPalette pal = textEdit->palette();
    QColor bg = treePalette.color(QPalette::AlternateBase);
...
void SearchResultsDock::newResultsEntry(const QString line, int lineNumber, int startPositionFromBeginning, int endPositionFromBeginning, int hitCount)
{
    ...
    applyResultPalette(resultTextEdit, ui->treeWidget->palette());
